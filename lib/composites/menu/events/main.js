...
const slideToggle = require('../../../commons/animation').slideToggle;
...
module.exports = (elements, update) => {
  ...
  delegate(elements.topBar, '[role="menuitem"] .dqpl-dropdown [role="menuitem"]', 'keydown', (e) => {
    const target = e.delegateTarget;
    console.log('keydown on the menu item of the shite!');
    switch (e.which) {
      case 38:
      case 40:
        e.preventDefault();
      ...
      case 27:
      case 37:
        console.log('bhybybybybby', target);
  ...
  delegate(elements.topBar, '.dqpl-dropdown', 'keydown', (e) => {
    ...
    if (which === 27 || which === 38) {
      console.log('WTHTEUEF KFADIF JDSFLKSDJF LSDKFJ SLDKFJ SDLKJ DLFKJ');
