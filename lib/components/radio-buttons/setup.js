...
const getLabel = require('../../helpers/get-label');
const getSelectedIndex = require('./get-selected-index');
const setSelected = require('./set-selected');
...
module.exports = () => {
  queryAll('.dqpl-radio-group')
    .forEach((radioGroup) => {
      const radios = queryAll('.dqpl-radio', radioGroup);
