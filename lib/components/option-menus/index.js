...
import isOutside from '../../commons/is-outside';
import getAdjacentItem from '../../commons/get-adjacent-item';
...
module.exports = () => {
  ...
  delegate(document.body, '.dqpl-options-menu [role="menuitem"]', 'keydown', (e) => {
    ...
    const menuOpen = trigger && (trigger.getAttribute('aria-expanded') === 'true');
