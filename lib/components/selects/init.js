...
module.exports = () => {
  queryAll('.dqpl-listbox-button')
    .forEach((listboxButton) => {
      ...
      // TODO: Assign pseduoval and id and ensure that the button is labelledby it?
      ...
      const activeId = listboxButton.getAttribute('aria-activedescendant');
